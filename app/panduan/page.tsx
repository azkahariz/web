...
const metadataGroups = [
  {
    ...
    fields: [
      ...
      ["AWS Center ID", "Aplikasi belum menetapkan definisi atau sumber resmi untuk field ini. Isi hanya nilai dari dokumen resmi, misalnya STA2062. Jika maksud atau sumber nilainya belum jelas, konfirmasikan kepada Super Admin."],
      ["Status Kepemilikan", "Pilih BMKG, Sewa, Hibah, Kerjasama Mitra, atau Lainnya."],
      ["Status Kepemilikan Lainnya", "Muncul setelah memilih Lainnya. Isi status kepemilikan yang benar."],
  ...
  },
  {
    ...
    fields: [
      ...
      ["Metode Ukur", "Pilih metode pengukuran yang benar."],
      ["Metode Ukur Lainnya", "Muncul setelah memilih Lainnya dan wajib diisi dengan metode yang digunakan."],
  ...
  },
  {
    ...
    fields: [
      ...
      ["Mulai Interval dan Akhir Interval", "Aplikasi belum menetapkan arti bisnis resmi untuk awal dan akhir periode ini. Isi hanya berdasarkan ketentuan pengelola; jika maksud periodenya belum jelas, konfirmasikan kepada Super Admin."],
      ["Interval Data (menit)", "Pilih 1, 2, 5, 10, atau 60 menit. Pilih Lainnya untuk memasukkan jumlah menit sendiri."],
      ["Interval Lainnya (menit)", "Muncul setelah memilih Lainnya. Isi bilangan menit yang benar."],
    ],
  },
] as const;
...
const troubleshooting = [
  {
    ...
    seen: "Muncul pesan Username atau password tidak sesuai, Konfigurasi login belum tersedia, atau login gagal diproses.",
    cause: "Username/password salah, akun belum aktif, konfigurasi layanan login belum tersedia, atau koneksi sedang bermasalah.",
    action: "Periksa penulisan username dan password, gunakan tombol mata bila perlu, lalu coba lagi setelah koneksi stabil.",
    admin: "Hubungi Super Admin jika password lupa, konfigurasi login belum tersedia, atau pesan tetap muncul.",
  },
  {
    title: "Akun stasiun belum siap",
    seen: "Setelah login, aplikasi menampilkan Akun stasiun belum siap dan pengisian tidak terbuka.",
    cause: "Akun belum terhubung ke Stasiun aktif atau hubungan akun tidak sesuai dengan master Stasiun saat ini.",
    action: "Klik Keluar, pastikan username yang digunakan benar, lalu laporkan pesan yang tampil kepada Super Admin.",
    admin: "Minta Super Admin memeriksa status akun, Stasiun, dan hubungan akun ke master. Jangan membuat akun pengganti sebelum penyebabnya dipastikan.",
  },
  {
  ...
  },
  {
    ...
    seen: "Muncul Konfigurasi Supabase belum tersedia, Master data gagal dimuat, Ringkasan server belum dapat dimuat, atau katalog Produk gagal dimuat.",
    cause: "Konfigurasi deployment belum tersedia, koneksi ke server terganggu, atau salah satu layanan data gagal memuat.",
